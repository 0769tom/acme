...
function main() {
  ...
  program
    ...
    .option('-d, --daemon', 'Run acme node as daemon')
  ...
  var pidFile = path.join(baseDir, 'acme.pid');
  if (fs.existsSync(pidFile)) {
    console.log('Failed: acme server already started');
    return;
  }
  ...
  if (program.daemon) {
    console.log('Acme server started as daemon ...');
    require('daemon')();
